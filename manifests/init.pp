...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      neutron_arp_responder         => hiera(openstack::neutron::neutron_arp_responder, $neutron_arp_responder),
      neutron_l2_population         => hiera(openstack::neutron::neutron_l2_population, $neutron_l2_population),
      neutron_enable_dvr            => hiera(openstack::neutron::neutron_enable_dvr, $neutron_enable_dvr),
