...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      neutron_agent_mode            => hiera(openstack::neutron::agent_mode, $neutron_agent_mode),
      neutron_router_distributed    => hiera(openstack::neutron::router_distributed, $neutron_router_distributed),
