...
class openstack (
  ...
  $neutron_enable_distributed_routing = undef,
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      neutron_enable_distributed_routing => hiera(openstack::neutron::neutron_enable_distributed_routing, $neutron_enable_distributed_routing),
